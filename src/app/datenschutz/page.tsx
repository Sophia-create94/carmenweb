...
export const metadata: Metadata = {
  ...
  description:
    "Datenschutzerklärung der Kinder- & Jugendarztpraxis Dr. med. Carmen Müller in Heidelberg – Informationen zur Verarbeitung personenbezogener Daten nach den Vorgaben der DSGVO.",
...
export default function DatenschutzPage() {
  return (
    <div className="page-content about-container">
      <h2 className="page-title">Datenschutzerklärung</h2>
      <p>
        für Websitebetreiber nach den Vorgaben der Datenschutzgrundverordnung
        (DSGVO)
      </p>

      <h3 className="subtitle">I. Name und Anschrift des Verantwortlichen</h3>
      <div className="section">
        ...
        <p>
          Dr. med. Carmen Müller<br />
          Fachärztin für Kinderheilkunde und Jugendmedizin<br />
          Dossenheimer Landstr. 40<br />
          69121 Heidelberg<br />
          Deutschland
        </p>
        <p>
          Tel.: 06221 412450<br />
          Fax: 06221 4348260<br />
          Email:{" "}
          <a href="mailto:praxisteammueller@web.de">praxisteammueller@web.de</a>
          <br />
          <a href="https://www.drcarmenmueller.de">www.drcarmenmueller.de</a>
        </p>
      </div>

      <h3 className="subtitle">II. Allgemeines zur Datenverarbeitung</h3>
      <div className="section">
      ...
      <h3 className="subtitle">IV. E-Mail-Kontakt</h3>
      <div className="section">
        <h4>1. Beschreibung und Umfang der Datenverarbeitung</h4>
        <p>
          Eine Kontaktaufnahme über die bereitgestellte E-Mail-Adresse ist
        ...
        <p>
          Die Verarbeitung der per E-Mail übermittelten personenbezogenen Daten
          dient uns allein zur Bearbeitung der Kontaktaufnahme. Hierin liegt
